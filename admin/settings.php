...
<form name="_xclick" action="https://www.paypal.com/in/cgi-bin/webscr" method="post" class="nocsrf">
    ...
    <input type="hidden" name="item_name" value="Shopclass project">
    ...
    <div id="flashmessage" class="flashmessage flashmessage-inline flashmessage-warning">
        <p><?php _e('I would like to contribute to the development of Shopclass with a donation of', 'bender'); ?> <select name="amount" class="select-box-medium">
    ...
    <fieldset>
        <div class="form-horizontal">
            ...
            <div class="form-row">
                ...
                <div class="form-controls">
                    <div class="form-label-checkbox"><input type="checkbox" name="footer_link" value="1" <?php echo (osc_get_preference('footer_link', 'bender') ? 'checked' : ''); ?> > <?php _e('I want to help Shopclass by linking to <a href="http://osclass.org/" target="_blank">osclass.org</a> from my site with the following text:', 'bender'); ?></div>
                    <span class="help-box"><?php _e('This website is proudly using the <a title="Shopclass web" href="http://osclass.org/">classifieds scripts</a> software <strong>Shopclass</strong>', 'bender'); ?></span>
                </div>
            </div>
            <?php } ?>
        </div>
